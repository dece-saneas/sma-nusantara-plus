				...
				<ul class="navbar-nav ml-md-auto">
					<li class="nav-item dropdown dropdown-user">
						<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
							    <img src="@role('Admin') {{ asset('img/placeholders/user.jpg') }} @endrole @role('User') {{ asset('img/berkas/'.Auth::user()->berkas->photo) }} @endrole" onerror="this.onerror=null;this.src='{{ asset('img/placeholders/user.jpg') }}';" class="rounded-circle mr-2" alt="" height="34">
